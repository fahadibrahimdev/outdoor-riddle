...
<template>
  <section id="faqs" class="faqs-section flex items-center relative h-[1200px] sm:h-[1100px] md:h-[1000px] xl:h-[1200px]">
    <div class="container pt-32 md:pt-52 text-center">
        <div>
...
.faqs-section::before {
  ...
  width: 100%;
  height: 100%;
  background: theme('backgroundColor.faq');
  opacity: .1;
